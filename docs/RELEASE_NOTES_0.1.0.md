...
- **Plugin migration** — 38 of harvey-os's 188 skills carry plugin manifests today (20 batch-migrated via `scripts/migrate_skill.py` in the launch sprint). The remaining 150 + 11 agent submodules port in waves through v0.2. The migration helper is shipped.
