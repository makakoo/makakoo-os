    ...
    def bootstrap(self) -> dict:
        ...
        for skill_md in harvey_os.rglob("SKILL.md"):
            try:
                ...
                page_content = (
                    f"- tags:: #skill #makakoo {f'#{category}' if category else ''}\n"
                    ...
                    f"- ## Overview\n"
                    f"  - {desc}\n"
                    f"  - Source: `plugins-core/{skill_md.relative_to(harvey_os)}`\n"
                )
        ...
        if core_dir.exists():
            for module_dir in sorted(core_dir.iterdir()):
                ...
                page_content = (
                    f"- tags:: #makakoo #core #{module_name}\n"
                    f"- auto-generated by bootstrap\n"
        ...
        if agents_dir.exists():
            for agent_dir in sorted(agents_dir.iterdir()):
                ...
                page_content = (
                    f"- tags:: #makakoo #agent #{agent_name}\n"
                    f"- auto-generated by bootstrap\n"
        ...
        caps_content = (
            "- tags:: #makakoo #index #capabilities\n"
