...
# ---------------------------------------------------------------------------
# Security scanner — from brain_writer.py (_scan_for_threats)
# ---------------------------------------------------------------------------
...
def _security_scan_skill(skill_dir: Path) -> Optional[str]:
    ...
    try:
        for skill_md in skill_dir.rglob("SKILL.md"):
            ...
            error = _scan_for_threats(content)
            if error:
                return error
        for subdir in ALLOWED_SUBDIRS:
        ...
        "properties": {
            ...
            "content": {
                ...
                "description": (
                    ...
                    "Required for 'create' and 'edit'. For 'edit', provide the complete updated text."
                )
            },
            "old_string": {
                "type": "string",
            ...
            "category": {
                "type": "string",
                "description": (
                    "Optional category/domain for organizing the skill (e.g., 'dev', 'ai-ml', "
                    "'infrastructure'). Creates a subdirectory grouping. "
