...
**Status:** v0.2.0 · shipped 2026-04-21 · **111 tests green** · DE + AR + ES + US regimes.
...
- Per-subcommand (init, doctor, onboard, log-hours, generate-invoice,
  ...
  dashboard) — happy + error + dry-run paths.
...
- Format fidelity — appending a row to real
...
- SANCHO autonomous watchdogs (overdue, KU threshold, weekly pipeline sync,
  homeoffice cap).
