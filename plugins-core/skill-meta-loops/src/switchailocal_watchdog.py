...
AIL_SH = os.environ.get("SWITCHAI_LOCAL_PATH", os.path.expanduser("~/projects/makakoo/agents/switchAILocal/ail.sh"))
HARVEY_HOME = Path(os.environ.get("HARVEY_HOME", os.path.expanduser("~/MAKAKOO")))
LOG_FILE = HARVEY_HOME / "data" / "logs" / "switchailocal-watchdog.log"
